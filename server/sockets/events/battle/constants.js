...
export const EVT_CLIENT_PLACE_NORMAL_BATTLE_BID         = 'place_normal_battle_bid';
...
export const EVT_EMIT_JOINED_BATTLE_LEVEL  				= 'joined_battle_level';
export const EVT_EMIT_UPDATE_NORMAL_BATTLE_LEVEL_DATA 	= 'update_normal_battle_level_data';
